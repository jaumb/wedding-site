$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $.post('https://script.google.com/macros/s/AKfycbxKJw3_Qw252tTiWssBixtGQmjcFPM6GbYTruIyyWWZtoo4RYZjczGWKBEf4E90QBCe/exec', data)
            .done(function (data) {
                console.log(data);
            ...
            .fail(function (data) {
                console.log(data);
                $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Something went wrong. Ensure your invite code is correct and try again. '));
            });
    });
